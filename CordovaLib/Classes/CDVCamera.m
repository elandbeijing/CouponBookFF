...
//        }
        ...
        // self.viewController를 [self topViewController]로 수정
        if ([[self topViewController] respondsToSelector:@selector(presentViewController:::)]) {
            [[self topViewController] presentViewController:cameraPicker animated:YES completion:nil];
        } else {
            [[self topViewController] presentModalViewController:cameraPicker animated:YES];
        }
