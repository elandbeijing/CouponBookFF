...
/*********** 기존소스
            ...
            execXhr.send(null);
*************/       
////////////// remote webview를 사용하기 위해 수정
           var param = new Object();
           param['vc'] = cordova.iOSVCAddr;
           param['rc'] = ++requestCount;
       
           if (shouldBundleCommandJson()) {
                param['cmds'] = iOSExec.nativeFetchMessages();
           }
           
           var url = "ff:///!gap_exec?param=" + JSON.stringify(param);
           execXhr.open('GET', url, true);
           execXhr.setRequestHeader('Content-Type', 'application/xml');
           execXhr.send(null);
//////////////////////////////////////////////////
